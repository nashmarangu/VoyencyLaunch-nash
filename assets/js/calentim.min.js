    ...
    e.defaults = (e.prototype = {
        ...
        monthSwitchClicked: function () {
            if (!(0 < this.calendars.find(".calentim-month-selector").length)) {
                ...
                t.css("display", "block"), 
                this.optimizeFontSize(t.find(".calentim-ms-month")), 
                t.find(".calentim-ms-month").parents(".calentim-month-selector").wrapInner( "<div class='cal_month_outr'><div class='cal_month_wpr'></div></div>" );
                
                t.find(".calentim-ms-month").off("click").on("click", function (t) {
        ...
        drawYearSwitch: function (t, e) {
            ...
            for (var a = e - 6; a < e + 6; a++) this.config.hideOutOfRange && (moment(a + "-06-01").isBefore(this.config.minDate, "year") || moment(a + "-06-01").isAfter(this.config.maxDate, "year")) ? t.append("<div class='calentim-ys-year-disabled'>&nbsp;</div>") : t.append("<div class='calentim-ys-year" + (i == a ? " current" : "") + "' data-year='" + a + "'>" + this.localizeNumbers(a) + "</div>");
        ...
        yearSwitchClicked: function () {
            if (!(0 < this.calendars.find(".calentim-year-selector").length)) {
                ...
                this.drawYearSwitch(n, t), n.css("display", "block"),
                 this.optimizeFontSize(n.find(".calentim-ys-year")),
                n.find(".calentim-ys-year, .calentim-ys-year-prev, .calentim-ys-year-next").parents(".calentim-year-selector").wrapInner( "<div class='cal_year_wpr'></div>" );
                 
                  v(r).off("click.calentimys").on("click.calentimys", ".calentim-ys-year", function (t) {
            ...
            switch (t) {
                case "left":
                    switch (this.config.arrowOn) {
                        case "top":
                            return {
                                top: e.offsetTop - n - s - e.height / 2, left: e.offsetLeft - i.width - n, arrow: 0
                            };
                        case "center":
                            return {
                                top: e.offsetTop - n - i.height / 2, left: e.offsetLeft - i.width - n, arrow: (i.height - 2 * s) / 2 - e.height / 2
                            };
                        case "bottom":
                            return {
                                top: e.offsetTop - i.height + e.height + 2 * n + s, left: e.offsetLeft - i.width - n, arrow: i.height - 4 * s - 3 * n - e.height / 2
                            };
                        default:
                            return {
                                top: e.offsetTop - n - s - e.height / 2, left: e.offsetLeft - i.width - n, arrow: 0
                ...
                case "right":
                    switch (this.config.arrowOn) {
                        case "top":
                            return {
                                top: e.offsetTop - n - s - e.height / 2, left: e.offsetLeft + e.width + n, arrow: 0
                            };
                        case "center":
                            return {
                                top: e.offsetTop - n - i.height / 2, left: e.offsetLeft + e.width + n, arrow: (i.height - 2 * s) / 2 - e.height / 2
                            };
                        case "bottom":
                            return {
                                top: e.offsetTop - i.height + e.height + 2 * n + s, left: e.offsetLeft + e.width + n, arrow: i.height - 4 * s - 3 * n - e.height / 2
                            };
                        default:
                            return {
                                top: e.offsetTop - n - s - e.height / 2, left: e.offsetLeft + e.width + n, arrow: 0
                ...
                case "top":
                    switch (this.config.arrowOn) {
                        ...
                        case "center":
                            return {
                                top: e.offsetTop - i.height - n, left: e.offsetLeft - (i.width - 2 * n - e.width) / 2, arrow: (i.width - 5 * s) / 2
                            };
                        case "right":
                            return {
                                top: e.offsetTop - i.height - n, left: e.offsetLeft - (i.width - e.width) + n, arrow: i.width - 5 * s + n
                            };
                        default:
                            return {
                                top: e.offsetTop - i.height - n, left: e.offsetLeft - n, arrow: 0
                ...
                case "bottom":
                    switch (this.config.arrowOn) {
                        case "left":
                            return {
                                top: e.offsetTop + e.height - n + s, left: e.offsetLeft - n, arrow: 0
                            };
                        case "center":
                            return {
                                top: e.offsetTop + e.height - n + s, left: e.offsetLeft - (i.width - 2 * n - e.width) / 2, arrow: (i.width - 5 * s) / 2
                            };
                        case "right":
                            return {
                                top: e.offsetTop + e.height - n + s, left: e.offsetLeft - (i.width - e.width) + n, arrow: i.width - 5 * s + n
                            };
                        default:
                            return {
                                top: e.offsetTop + e.height - n + s, left: e.offsetLeft - n, arrow: 0

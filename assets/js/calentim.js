...
(function ($, window, document, undefined) {
    ...
    calentim.prototype = {
        ...
        monthSwitchClicked: function () {
            ...
            // monthSelector.find(".calentim-ms-month").parents(".calentim-month-selector").wrapInner( "<div class='new'></div>" );
        ...
        yearSwitchClicked: function () {
            ...
            // t.find(".calentim-year-selector, .calentim-ys-year-prev").parents(".calentim-ys-year").wrapInner( "<div class='cal_year_wpr'></div>" );

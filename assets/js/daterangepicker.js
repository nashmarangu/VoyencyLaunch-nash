!(function (t, e) {
  ...
  var a = function (a, i, s) {
    if (
      ...
      (i = e.extend(this.element.data(), i)),
      'string' == typeof i.template ||
      ...
      (this.parentEl = e(
        i.parentEl && e(i.parentEl).length ? i.parentEl : this.parentEl
      )),
      ...
      'object' == typeof i.locale &&
        ...
        'string' == typeof i.locale.customRangeLabel &&
          (this.locale.customRangeLabel = i.locale.customRangeLabel)),
      ...
      for (var n = this.locale.firstDay; n > 0; )
        this.locale.daysOfWeek.push(this.locale.daysOfWeek.shift()), n--
    var r, h, o
    if (
      'undefined' == typeof i.startDate &&
      'undefined' == typeof i.endDate &&
      ...
      ;(r = h = null),
        2 == c.length
          ? ((r = t(c[0], this.locale.format)),
            (h = t(c[1], this.locale.format)))
          : this.singleDatePicker &&
            '' !== l &&
            ((r = t(l, this.locale.format)), (h = t(l, this.locale.format))),
        null !== r && null !== h && (this.setStartDate(r), this.setEndDate(h))
    }
    if ('object' == typeof i.ranges) {
      for (o in i.ranges) {
        ...
        if (
          (this.dateLimit &&
            d &&
            r.clone().add(this.dateLimit).isAfter(d) &&
            (d = r.clone().add(this.dateLimit)),
          d && h.isAfter(d) && (h = d.clone()),
          !(
            (this.minDate &&
              h.isBefore(this.minDate, this.timepicker ? 'minute' : 'day')) ||
            (d && r.isAfter(d, this.timepicker ? 'minute' : 'day'))
          ))
        ) {
    ...
    'function' == typeof s && (this.callback = s),
      ...
      this.singleDatePicker &&
        ...
        this.timePicker
          ...
          : this.container.find('.ranges').hide()),
      (('undefined' == typeof i.ranges && !this.singleDatePicker) ||
        this.alwaysShowCalendars) &&
        this.container.addClass('show-calendar'),
      this.container.addClass('opens' + this.opens),
      'undefined' != typeof i.ranges &&
        'right' == this.opens &&
        this.container
          .find('.ranges')
  ...
  return (
    (a.prototype = {
      ...
      renderCalendar: function (a) {
        ...
        for (
          var k, y, v = t([f, m, D, 12, h, o]), g = 0, k = 0, y = 0;
          42 > g;
          g++, k++, v = t(v).add(24, 'hour')
        )
          g > 0 && k % 7 === 0 && ((k = 0), y++),
            (i[y][k] = v.clone().hour(r).minute(h).second(o)),
            v.hour(12),
            this.minDate &&
              i[y][k].format('YYYY-MM-DD') ==
                this.minDate.format('YYYY-MM-DD') &&
              i[y][k].isBefore(this.minDate) &&
              'left' == a &&
              (i[y][k] = this.minDate.clone()),
            this.maxDate &&
              i[y][k].format('YYYY-MM-DD') ==
                this.maxDate.format('YYYY-MM-DD') &&
              i[y][k].isAfter(this.maxDate) &&
              'right' == a &&
              (i[y][k] = this.maxDate.clone())
        'left' == a
            ...
            _ +=
              (!S || B >= C.month()) && (!A || B <= b.month())
                ...
                : "<option value='" +
                  ...
                  '</option>'
          _ += '</select>'
          for (var E = '<select class="yearselect">', W = L; I >= W; W++)
            E +=
              '<option value="' +
              W +
              '"' +
        ...
        if (
          ((w += '<th colspan="5" class="month">' + P + '</th>'),
          (w +=
            (b && !b.isAfter(i.lastDay)) ||
          ...
          (w += '<tr>'),
          (this.showWeekNumbers || this.showISOWeekNumbers) &&
            (w += '<th class="week">' + this.locale.weekLabel + '</th>'),
        ...
        for (var y = 0; 6 > y; y++) {
          ;(w += '<tr>'),
            this.showWeekNumbers
              ? (w += '<td class="week">' + i[y][0].week() + '</td>')
              : this.showISOWeekNumbers &&
                (w += '<td class="week">' + i[y][0].isoWeek() + '</td>')
          for (var k = 0; 7 > k; k++) {
            var N = []
            i[y][k].isSame(new Date(), 'day') && N.push('today'),
              ...
              this.minDate &&
                i[y][k].isBefore(this.minDate, 'day') &&
                N.push('off', 'disabled'),
            ...
            for (var j = '', H = !1, g = 0; g < N.length; g++)
        ...
        ;(w += '</tbody>'),
          (w += '</table>'),
          this.container.find('.calendar.' + a + ' .calendar-table').html(w)
      },
      renderTimePicker: function (t) {
        if ('right' != t || this.endDate) {
          ...
          for (var l = 0; 60 > l; l += this.timePickerIncrement) {
            var f = 10 > l ? '0' + l : l,
              d = a.clone().minute(l),
              m = !1
      ...
      hoverDate: function (t) {
        if (e(t.target).hasClass('available')) {
          ...
          !this.container.find('input[name=daterangepicker_start]').is(':focus')
            ? this.container
                .find('input[name=daterangepicker_start]')
                .val(r.format(this.locale.format))
            : this.endDate ||
              this.container
                .find('input[name=daterangepicker_end]')
                .is(':focus') ||
          ...
          var h = this.leftCalendar,
            ...
            l = this.startDate
          this.endDate ||
            this.container.find('.calendar td').each(function (t, a) {
              if (!e(a).hasClass('week')) {
                ...
                ;(d.isAfter(l) && d.isBefore(r)) || d.isSame(r, 'day')
        ...
        if (
          ...
          2 === e.length &&
            ...
            (this.singleDatePicker || null === a || null === i) &&
              ((a = t(this.element.val(), this.locale.format)), (i = a)),
            a.isValid() &&
              i.isValid() &&
